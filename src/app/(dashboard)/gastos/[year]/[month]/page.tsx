...
import { GastosView } from "@/components/finance/GastosView"
import { seedDefaultPersonalCategories } from "@/app/(dashboard)/personal/actions"

export default async function GastosMesPage({
  params,
}: {
  ...
  if (isNaN(year) || isNaN(month) || month < 1 || month > 12) redirect("/gastos")
  ...
  return <GastosView year={year} month={month} categories={categories} transactions={transactions} />
}
